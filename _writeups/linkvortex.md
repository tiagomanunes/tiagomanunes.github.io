...
Welcome! We are finally here: this is the first of my Honest Write-ups to be blinded by the light of day. I rooted my first few Hack The Box machines back in October/November last year, when I started [the CPTS path](/articles/oscp-via-cpts/), but then focused on studying. It was actually during the exam that the idea for these came to mind. An honest report would be _very_ different. "The tester made a stupid typo and assumed the target machine was down", or "at this point, the tester was stuck for days". Now that CPTS is out of the way, I'm back to solving these machines, and will write honestly about them.

LinkVortex, and another easy-rated machine that I won't name yet (edit: it was [Dog](/writeups/dog/)), made me worry. I had stumbled my way to root on a few easy boxes at the start of my CPTS path. I rooted a few more after CPTS, graduating to medium machines and feeling almost at ease. Then I tried that other easy one, and I got _nothing_. Staring at a web application's login page, all the enumeration steps I knew of done, all the very few options exhausted. Stunned, I set it aside and moved on to LinkVortex, one week before its retirement. Spoiler alert:
