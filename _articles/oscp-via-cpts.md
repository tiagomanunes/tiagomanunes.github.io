...
I was lucky to grow up with access to a computer (an [IBM PS/1](https://en.wikipedia.org/wiki/IBM_PS/1#Models_2011)!), so my interest in programming started early, and the fascination with hacking followed soon after. I went on to study software engineering, but in parallel I was getting yelled at by my family for staying up all night trying to beat [wargames](https://web.archive.org/web/20051124165147/http://www.dievo.org/index.php?cmd=1&part=2&PHPSESSID=b367364a1fa0c6379594c8553b5a0c0a). With the start of my career, I lost the habit... until mid-2021, when I started playing around again on TryHackMe in my spare time. In 2023, I had the opportunity to join the infosec team at the company I’d been with for a few years, and finally got paid to hack! My next job after that was back in leadership, though quite hands-on due to the size of the structure, with (defensive) security as one of my responsibilities.

After I resigned from that role, I paused to figure out where I wanted to go. I decided it was finally time to listen to that calling, and that my background could bring a ton of value in offensive security. Looking at the interesting jobs around me, all of them listed the OSCP as a requirement at some level. Despite that fascination, all I had to show for it was some very spotty knowledge. So I was going to take the time to properly learn the skills, earn the certification to validate them, and finally attack the job market.
...
Let's talk monies. OSCP is already expensive, how much are these extra lessons going to cost? Surprisingly, less than 10% of the cheapest OSCP bundle. You would think that a long course would be a nightmare on a subscription model, but you can actually take the course for as little as $110 total (I'll explain how later), or even $8 a month if you are a student.
